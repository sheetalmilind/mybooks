...
const FriendsPage = () => {
  ...
  const fetchFriends = async () => {
    try {
      const response = await axios.get(`${SERVER_URL}/api/users/${userId}/friends`);
  ...
  const searchUsers = async () => {
    ...
    try {
      const response = await axios.get(`${SERVER_URL}/api/users/search?query=${searchQuery}`);
  ...
  const addFriend = async (friendId) => {
    try {
      const response = await axios.post(`${SERVER_URL}/api/users/add-friend`, {
        userId,
        friendId,
      });
